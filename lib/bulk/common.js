 ...
 * @extends {MongoError}
 */
// AR: mongodb-core-v3.1.1 MongoError is a class, cannot call its constructor directly
...
class BulkWriteError extends MongoError {
  ...
  // AR: MongoError is a class, avoid "Class constructor MongoError cannot be invoked without 'new'"
